...
import { IoAddCircleSharp, IoArrowBack } from "react-icons/io5";
      ...
      <div className="user-profile">
        ...
        <div className="profile-details">
          <div className="profile-image">
            <img
              src={user.profilePic || post.authorImage||"/bg.jpg"}
              alt="Profile"
        ...
        <Followers />
        <h1 className="user-name">{user.name || post.fullName}</h1>
      </div>
      <div className="action-buttons">
        <button className="btn message-btn">
          <BiSolidMessageRoundedDots className="btnicon" /> Message
        </button>
        <button className="btn follow-btn">
          <IoAddCircleSharp className="btnicon" />
          Follow
        </button>
      </div>
      {/* Tabs Section */}
